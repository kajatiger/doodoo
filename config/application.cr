...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Doodoo web application."
  #
  #
  ...
  #
  # settings.secret_key_base= SLZRK5BcUMIFg9DUun7SquP_A9Wkx1i9Fy-R8S75-Bc
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("doodoo.log", "w"))
  #
  #
end
